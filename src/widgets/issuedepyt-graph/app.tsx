        ...
        {graphVisible && (<Tabs selected={selectedTab} onSelect={setSelectedTab}>
          <Tab id="main" title="Graph">
            {Object.keys(issueData).length > 0 && (
              <DepGraph issues={issueData} maxNodeWidth={maxNodeWidth} setSelectedNode={setSelectedNode} />
            )}
          ...
          <Tab id="settings" title="Settings">
            <SettingsPane maxDepth={maxDepth} setMaxDepth={setMaxDepth} maxNodeWidth={maxNodeWidth} setMaxNodeWidth={setMaxNodeWidth} />
          </Tab>
          <CustomItem>
